...
function realizarCadastro(event) {
    ...
    alert("🎉 Cadastro realizado com sucesso! Bem-vinda ao Viva Mulher. Por favor, faça o seu login.");
    mostrarPagina('login'); // Redireciona para o login
}
...
// Função para o Menu (Responsividade do Dashboard)
function toggleMenu() {
    const sidebar = document.querySelector('.sidebar');
    if (sidebar) {
        // O toggle adiciona a classe 'ativo' se ela não existir, e remove se ela já existir
...
// Esta função recebe o caminho da página e envia o usuário para lá
